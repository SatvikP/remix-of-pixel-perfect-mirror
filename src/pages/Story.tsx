...
const painPoints = [
  { icon: Database, text: "Data scattered across tools" },
  { icon: Clock, text: "CRM goes stale quickly" },
  { icon: Mail, text: "Outreach is manual and slow" },
  { icon: Users, text: "Context lost between platforms" },
  { icon: Zap, text: "Good startups contacted too late" },
];
